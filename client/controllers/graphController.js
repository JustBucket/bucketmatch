...
function GraphController($scope, GraphFactory) {
  ...
  console.log('d3 map: ', buckets);
  // reassigns the map to the bucket list items
  buckets = data.buckets;

  console.log('new data format of names: ', data.names);
  console.log('new data format of buckets', data.buckets);
  console.log('data now has paths also', paths);
